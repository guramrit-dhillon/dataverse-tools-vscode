...
export class EntityPanel extends Panel {
  ...
  private constructor(
    ...
    this.initListeners({
      ...
      openViewDesigner: ({ savedqueryid, entityLogicalName, entityDisplayName }: { savedqueryid: string; entityLogicalName: string; entityDisplayName?: string }) => {
        ViewDesignerPanel.render(
          this.extensionUri,
          this.env,
          this.metadataSvc,
          entityLogicalName,
