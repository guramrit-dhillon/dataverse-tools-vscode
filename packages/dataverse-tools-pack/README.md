...
A complete toolkit for Dynamics 365 / Power Platform plugin development in VS Code — deploy, register, trace, decompile, and query Dataverse without leaving your editor.
...
| Extension                       | Description                                              |
| ------------------------------- | -------------------------------------------------------- |
| **Dataverse Tools: Metadata**   | Browse entity metadata in the explorer tree              |
| **Dataverse Tools: Assemblies** | Deploy, register, and manage plugin assemblies and steps |
| **Dataverse Tools: Decompiler** | Browse source code of any assembly in dataverse          |
